...
struct ScreenHost: View {
    ...
    var body: some View {
        ...
        // MARK: Phase 2 · the demo path
        case .auditoria: ScreenStub(.auditoria, recordID: recordID, phase: 2)
        case .baterias: ScreenStub(.baterias, recordID: recordID, phase: 2)
        case .cadena: ScreenStub(.cadena, recordID: recordID, phase: 2)
        case .energia: ScreenStub(.energia, recordID: recordID, phase: 2)
        case .evento: ScreenStub(.evento, recordID: recordID, phase: 2)
        case .factura: ScreenStub(.factura, recordID: recordID, phase: 2)
        case .facturas: ScreenStub(.facturas, recordID: recordID, phase: 2)
        case .home: ScreenStub(.home, recordID: recordID, phase: 2)
        case .nodo: ScreenStub(.nodo, recordID: recordID, phase: 2)
        case .red: ScreenStub(.red, recordID: recordID, phase: 2)
        case .salud: ScreenStub(.salud, recordID: recordID, phase: 2)
        case .solar: ScreenStub(.solar, recordID: recordID, phase: 2)
        case .ups: ScreenStub(.ups, recordID: recordID, phase: 2)
